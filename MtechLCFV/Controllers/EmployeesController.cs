...
using MtechLCFV.Models;

namespace MtechLCFV.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder)
        {
            ...
            switch (sortOrder)
            {
                case "Name":
                    ...
                    break;
                case "Date":
                    employees = employees.OrderBy(s => s.BornDate);
                    break;
                case "date_desc":
                    employees = employees.OrderByDescending(s => s.BornDate);
                    break;
                default:
        ...
        {
            var vm = new Employee();
            vm.EmployeeStatusL = new List<SelectListItem>
            {
                new SelectListItem {Text = "NotSet", Value = "1"},
